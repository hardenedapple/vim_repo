...
syn region	rtlCComment	start="/\*" end="\*/" extend
syn region	rtlCCommentL	start="//" skip="\\$" end="$" keepend
...
hi def link rtlCommentSingle    Comment
hi def link rtlCComment         Comment
hi def link rtlCCommentL        Comment
hi def link rtlLocation         Debug
hi def link rtlString           String

" http://vim.wikia.com/wiki/Different_syntax_highlighting_within_regions_of_a_file
" Want everything within {} braces to be highlighted as C code.
